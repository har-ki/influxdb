...
func NewLogFile() *LogFile {
	return &LogFile{
		...
		mSketch:  hll.MustNewPlus(hll.DefaultPrecision),
		mTSketch: hll.MustNewPlus(hll.DefaultPrecision),
		sSketch:  hll.MustNewPlus(hll.DefaultPrecision),
		sTSketch: hll.MustNewPlus(hll.DefaultPrecision),
	}
}
